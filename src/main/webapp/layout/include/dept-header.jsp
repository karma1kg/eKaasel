                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-right">
                            <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/dept_login'/>"><i class="fa fa-home fa-fw" style="color: #011ED3"></i> Dashboard </a></li>
                            <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/dept_login/usergrievance'/>"><i class="fa fa-home fa-fw" style="color: #011ED3"></i> Lodge your Grievance</a></li>
                            <li><a style="color: #011ED3; font-size: large";  href="<c:url value='/dept_login/grievance_status'/>" ><i class="fa fa-file-text fa-fw" style="color: #011ED3"></i> Check Grievance Status</a></li>

                            <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/dept_login/taskList'/>"> <i class="fa fa-tasks" style="color: #011ED3"></i> Back To TaskList</a></li>

                            <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/dept_login/generate_report'/>"><i class="fa fa-bar-chart" style="color: #011ED3"></i> View Report</a></li>
                        </ul>
                    </div>
                </div>
