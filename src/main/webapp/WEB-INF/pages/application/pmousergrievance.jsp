...
<div class="container" id="targetIds">
    <div class="card">
        ...
        <form class="card-body form-horizontal"  id="applicationForm"  method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading"><label style="color: #000000">Enter your details:</label></div>
                    <div class="panel-body">
                        <div class="form-group row">
                            <label class="col-lg-2 required"><b style="color: #000000">CID No : </b></label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control field numeric border-secondary center-block" onkeypress="return isNumberKey(event)" id="cid" name="cidNo" onchange="getCidDetails()"  maxlength="11">
                                <span id="cidNoErrorMsg" class="text-danger"></span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-lg-2 required"><b style="color: #000000">Full Name : </b></label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 required"><b style="color: #000000">Address : </b></label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 required"><b style="color: #000000">Mobile Number : </b>
                            </label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 "><b style="color: #000000">Email Id : </b></label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 required"><b style="color: #000000">Grievance Description : </b> </label>
                            <div class="col-lg-1"></div>
                            <div class="col-lg-9">
                                <textarea class="form-control field border-secondary" id="public_area" name="appl_Type_Remark"></textarea>
                                <span id="desc_ErrorMsg" class="text-danger"></span>
                            </div>
                        </div>
