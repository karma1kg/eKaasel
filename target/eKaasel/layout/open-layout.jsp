...
<head>
    ...
    <link rel="shortcut icon" class="fa fa-leaf" alt="public_grievance" style="height:100px;width:100px" href="<c:url value='/resources/images/logo1.png' />"
...
<div class="my-3 my-md-5">
    <div class="container" id="openLayout">
