                            ...
                            <li>
                                <div class="dropdown">
                                    <button class="btn btn-primary dropdown-toggle user-info" type="button" data-toggle="dropdown">
                                        ...
                                        <span>Welcome PMO User,</span>
                                        <span>PSGRD</span>
                                       </button>
                                    <ul class="dropdown-menu" style="text-align: left; min-width: 100%">
                                        <li><a data-toggle="modal" target="_blank"  href="${pageContext.request.contextPath}/resources/images/file.pdf"><i class="fa fa-info-circle fa-fw"></i> Help</a></li>
                                        <li><a href="#"><i class="fa fa-gears fa-fw"></i> Change Role</a></li>
                                        <li class="divider"></li>
                    ...
                    <div class="col-md-12">
                        <div class="navbar-collapse collapse ">
                            <ul id="menu-top" class="nav navbar-right">
                                <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/pmoLogin'/>"><i class="fa fa-home fa-fw" style="color: #011ED3"></i> Dashboard </a></li>
                                <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/pmoLogin/pmousergrievance'/>"><i class="fa fa-home fa-fw" style="color: #011ED3"></i> Lodge your Grievance</a></li>
                                <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/pmoLogin/grievance_status'/>"><i class="fa fa-file-text fa-fw" style="color: #011ED3"></i> Check Grievance Status</a></li>

                                <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/pmoLogin/taskList'/>" ><i class="fa fa-tasks fa-fw" style="color: #011ED3"></i> Back To TaskList</a></li>

                                <li><a style="color: #011ED3; font-size: large"; href="<c:url value='/pmoLogin/generate_report'/>"><i class="fa fa-bar-chart" style="color: #011ED3"></i> View Report</a></li>
                            </ul>
                        </div>
                    </div>
