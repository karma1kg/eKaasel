    ...
    <div class="panel-body">
        <div class="table-responsive" id="tblMinisterFwd">
            <table id="minister" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <%List<WorkFlowDTO> workFlowDTO1s = (List<WorkFlowDTO>) request.getAttribute("returned");%>
...
<script>
    function task_list(appNo){
        var url='${pageContext.request.contextPath}/dept_login/empty/getApplicationDetail?appNo='+appNo;
        $('#openLayout_dept').load(url);
    }
